...
- [DSH subagent companion bundle](integrations/dsh/sacha-subagents/README.md)独立安装，只把 DSH 官方 continuable-subagent 能力组合成 `sacha_research`、`sacha_worker`、`sacha_review` 三个 Adapter surface；不拥有 Gate、Manager DAG、授权或完成判断。
