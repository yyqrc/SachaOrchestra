...
Sacha Orchestra 是跨项目、多智能体的工作流协调框架。本仓库包含平台中立的核心协议、Codex、Claude Code、Cursor 与 DeepSeek Harness 运行适配、四个 Runtime 共用的 Agent Plugin 源码与 marketplace 清单，以及独立安装的单一 DSH companion。
