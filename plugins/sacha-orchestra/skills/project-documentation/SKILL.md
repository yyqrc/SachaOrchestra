...
4. 入口校验 Integration、授权、root containment、结构、preimage 与 path；发布文档只原子新建。Context 只写 Project Context path 指定的 `CONTEXT.md` managed 区；修改既有定义须 per-write confirmation，并发变化拒绝。
